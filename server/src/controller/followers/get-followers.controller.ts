...
const SQL_QUERY = "SELECT * FROM USER_FOLLOWING WHERE USER_EMAIL=?"


const GET_FOLLOWERS = async (req: RequestType, res: Response) => {
    ...
    try {
        ...
        res.send({ msg: "Your followers", users: result });
