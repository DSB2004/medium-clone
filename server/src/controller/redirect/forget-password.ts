//  to handle verification for password-reset
...
const FORGET_PASSWORD = async (req: RequestType, res: Response) => {
    ...
    try {
        ...
        const session = await SET_OTP_SESSION({ SESSION_TYPE: "FORGET_PASSWORD", EMAIL: EMAIL, OTP: OTP })
        // // mail function
